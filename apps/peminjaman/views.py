...
class PeminjamanAlatDetailView(DetailView):
    ...
    def get_queryset(self):
        queryset = super().get_queryset().select_related('barang', 'barang__inventaris', 'barang__lokasi')
        return scope_peminjaman_for_pengguna(queryset, getattr(self.request, 'current_pengguna', None))
