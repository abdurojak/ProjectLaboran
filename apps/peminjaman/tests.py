...
class PeminjamanViewsTests(TestCase):
    ...
    def test_form_peminjaman_memakai_dialog_pencarian_detail_barang(self):
        ...
        self.assertContains(response, 'html[data-theme="dark"] [data-barang-picker-modal]')
        self.assertContains(response, 'tr:has([data-barang-picker-choice]:checked) td')
        self.assertContains(response, 'tr:has([data-barang-picker-choice]:disabled) td')
        self.assertContains(response, 'html[data-theme="dark"] [data-barang-photo-empty]')
