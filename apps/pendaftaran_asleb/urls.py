...
urlpatterns = [
    ...
    path('<int:pk>/terima/konfirmasi/', confirm_accept_pendaftaran, name='pendaftaran_accept_confirm'),
    path('<int:pk>/pindahkan/', move_pendaftaran, name='pendaftaran_move'),
