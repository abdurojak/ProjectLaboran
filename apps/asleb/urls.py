...
from .views import (
    ...
    preview_laporan_praktikum_page,
...
urlpatterns = [
    ...
    path('laporan-praktikum/pengumpulan/<int:pk>/preview/halaman/<int:page>.png', preview_laporan_praktikum_page, name='laporan_preview_page'),
