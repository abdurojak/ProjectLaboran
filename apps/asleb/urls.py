...
from .views import (
    ...
    delete_laporan_praktikum,
    cancel_laporan_praktikum,
    ...
    grant_manual_attendance_permission,
    manual_attendance_schedule_options,
    revoke_manual_attendance_permission,
...
urlpatterns = [
    ...
    path('absensi/izin-manual/', grant_manual_attendance_permission, name='absensi_manual_grant'),
    path('absensi/izin-manual/jadwal/', manual_attendance_schedule_options, name='absensi_manual_schedules'),
    path('absensi/izin-manual/<int:pk>/batalkan/', revoke_manual_attendance_permission, name='absensi_manual_revoke'),
    ...
    path('laporan-praktikum/pengumpulan/<int:pk>/hapus/', delete_laporan_praktikum, name='laporan_delete'),
    path('laporan-praktikum/pengumpulan/<int:pk>/batalkan/', cancel_laporan_praktikum, name='laporan_cancel'),
