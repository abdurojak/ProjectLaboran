...
class AbsensiMasukAsleb(models.Model):
    ...
    latitude = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True)
    longitude = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True)
    jarak_lokasi_meter = models.DecimalField(max_digits=9, decimal_places=2, blank=True, null=True)
    akurasi_gps_meter = models.DecimalField(max_digits=8, decimal_places=2, blank=True, null=True)
