...
class LocalContainerWorkflowContractTests(unittest.TestCase):
    def test_local_container_workflow_waits_for_successful_image_publish(self):
        ...
        self.assertIn("/home/admin/LabTif/Storage:/app/media", workflow)
        self.assertNotIn("/home/admin/LabTif/Storage:/app/media:Z", workflow)
        self.assertIn("--security-opt label=disable", workflow)
